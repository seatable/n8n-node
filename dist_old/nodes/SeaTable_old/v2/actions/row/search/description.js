...
exports.rowSearchDescription = void 0;
exports.rowSearchDescription = [
    {
    ...
    },
    {
        ...
        default: false,
        description: 'FALSE: The search only results perfect matches. TRUE: Finds a row even if the search value is part of a string.',
    },
    {
