...
declare type SeaTableMap = {
    row: 'create' | 'get' | 'search' | 'update' | 'remove' | 'lock' | 'unlock';
    base: 'snapshot' | 'metadata' | 'apiCall' | 'collaborator';
    link: 'add' | 'remove';
    asset: 'upload' | 'getPublicURL';
};
export declare type SeaTable = AllEntities<SeaTableMap>;
export declare type SeaTableRow = Entity<SeaTableMap, 'row'>;
export declare type SeaTableBase = Entity<SeaTableMap, 'base'>;
export declare type SeaTableLink = Entity<SeaTableMap, 'link'>;
export declare type SeaTableAsset = Entity<SeaTableMap, 'asset'>;
export declare type RowProperties = PropertiesOf<SeaTableRow>;
export declare type BaseProperties = PropertiesOf<SeaTableBase>;
export declare type LinkProperties = PropertiesOf<SeaTableLink>;
export declare type AssetProperties = PropertiesOf<SeaTableAsset>;
